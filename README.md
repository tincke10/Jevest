...
| **H1** | "Is this LLM finding a real defect?" — the central hypothesis | Re-scored against a fix-aware oracle label (299 findings, n=7 real / 239 noise): Jev AUC 0.708 (was 0.592 vs. line-overlap), DeepSeek judge AUC 0.700 (was 0.567) — real signal this time, but only 25% of the noise is removed at full recall. Full numbers: [docs/BENCHMARK.md](docs/BENCHMARK.md) | **FAIL** formally (n=7 too small for the recall bar) |
...
- [ ] H1b · reversed-hunk dataset for a real-finding population (≈ USD 10 DeepSeek)

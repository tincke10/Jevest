...
El 2026-09-23 corrió la variante dura, `coherence-pairs-hard.jsonl` (mismas 100 PRs; la descripción cruzada es la PR más similar del mismo repo por Jaccard de directorio — p10 0.25 / p50 0.75 / p90 1.00, semilla 42, reuso de donante ≤ 2; 23 de 100 pares con fuga de nombre de archivo contra 6 en el cruce aleatorio; generado con `pnpm dataset:pairs --strategy hard`, sin red — datasets/README.md §4b). Corrida completa contra Jev en vivo, 400 requests (`reports/spike-coherence-2026-09-23T14-22-36-776Z.md`): con resumen, recall 0.970, precisión 1.000, F1 0.985 al umbral 0.65, ECE 0.082 — **PASS**; sin resumen, recall 0.830, precisión 0.830, F1 0.830 al umbral 0.15, ECE 0.178 — **PARCIAL** (recall y ECE por debajo de la barra). Frente al cruce aleatorio, los donantes casi duplicados cuestan 2 puntos de recall con el resumen y 5 sin él; la precisión con resumen se mantiene en 1.000. Lectura: el resumen sigue siendo la entrada que sostiene el veredicto; sin él, el recall cae del lado equivocado de la barra apenas la descripción cruzada se parece más al cambio real. Reproducir a costo cero: `pnpm coherence --pairs datasets/coherence-pairs-hard.jsonl --mode replay`.
...
| 2026-09-23: H7 hard PASS con resumen, PARCIAL sin resumen | Corrida completa sobre `coherence-pairs-hard.jsonl` (cruce por la PR más similar del mismo repo, no al azar — §4.4): con resumen recall 0.970, precisión 1.000, ECE 0.082 al umbral 0.65 (**PASS**); sin resumen recall 0.830, precisión 0.830, ECE 0.178 al umbral 0.15 (**PARCIAL**, recall y ECE por debajo de la barra) | El resumen sigue siendo imprescindible: sin él el recall cae por debajo del 0.90 exigido apenas la descripción cruzada se acerca al cambio real; la etapa 1 no cambia su adopción del state de tres capas |
